...
def visualise_gan(data_continuous_real, data_continuous_syn, data_discrete_real, data_discrete_syn, inx, num_dim=12, num_plot=10, SAVE_PATH="logs/"):
    ...
    data_continuous_real = renormalizer(data_continuous_real, max_val_con, min_val_con)
    data_continuous_syn = renormalizer(data_continuous_syn, max_val_con, min_val_con)
